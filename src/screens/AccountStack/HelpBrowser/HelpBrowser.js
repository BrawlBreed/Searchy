...
import { View, ActivityIndicator, Text, Image, Touchable, TouchableOpacity } from 'react-native'
...
function HelpBrowser() {
  ...
  return (
    <SafeAreaView style={[styles.flex, styles.safeAreaview]}>
      ...
      <TextDefault textColor={colors.fontPlaceholder} bold center small style={{ textDecorationLine: "underline", paddingBottom: 10  }}>
        {'Условия за ползване'}
      </TextDefault>
      </ScrollView>
    </SafeAreaView>
